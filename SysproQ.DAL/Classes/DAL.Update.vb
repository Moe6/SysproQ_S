...
Public Class Update
    ...
    Public Sub Update(obj As SorDetail)
        If _db.SorDetails.Where(Function(c) c.SalesOrder = obj.SalesOrder And c.SalesOrderLine = obj.SalesOrderLine _
                                    And c.MStockCode = obj.MStockCode).Any Then
            SetObjectModified(obj)
        Else
            SetObjectAdded(obj)
        End If
    ...
    Public Sub Update(obj As InvWarehouse)
        If _db.InvWarehouses.Where(Function(c) c.StockCode = obj.StockCode And c.Warehouse = obj.Warehouse).Any Then
            SetObjectModified(obj)
        Else
            SetObjectAdded(obj)
        End If

...
Public Class Query
    ...
    Public Function FillInveWarehouse(stockcode As String, wh As String) As InvWarehouse
        Return _db.InvWarehouses.Where(Function(c) c.StockCode = stockcode And c.Warehouse = wh).FirstOrDefault
    End Function
